...
> Criar endpoint GET /suppliers/by-unit/{unitId} no backend monorepo. Implementar módulo de fornecedores baseado na estrutura de dados existente em fornecedores_outros-estados.json.
