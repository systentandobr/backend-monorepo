...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_systentandobr_invest-tracker_internal_domain_analysis_entity.MarketAnalysis"
                        }
                    },
                    "500": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_systentandobr_invest-tracker_internal_domain_analysis_entity.Opportunity"
                        }
                    }
                ],
                "responses": {
        ...
        "/goals": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_systentandobr_invest-tracker_internal_domain_user_entity.FinancialGoal"
                            }
                        }
                    },
                    "500": {
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created financial goal",
                        "schema": {
                            "$ref": "#/definitions/github_com_systentandobr_invest-tracker_internal_domain_user_entity.FinancialGoal"
                        }
                    },
        ...
        "/goals/{id}": {
            ...
            "patch": {
                ...
                "responses": {
                    "200": {
                        "description": "Updated financial goal",
                        "schema": {
                            "$ref": "#/definitions/github_com_systentandobr_invest-tracker_internal_domain_user_entity.FinancialGoal"
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_systentandobr_invest-tracker_internal_domain_notification_entity.Notification"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_systentandobr_invest-tracker_internal_domain_user_entity.Portfolio"
                        }
                    },
                    "500": {
                        "description": "Internal server error",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_systentandobr_invest-tracker_internal_domain_simulation_entity.Simulation"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "github_com_systentandobr_invest-tracker_internal_domain_analysis_entity.InvestmentStrategy": {
            "type": "string",
            "enum": [
                "value",
                "growth",
        ...
        "github_com_systentandobr_invest-tracker_internal_domain_analysis_entity.MarketAnalysis": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
        ...
        "github_com_systentandobr_invest-tracker_internal_domain_analysis_entity.Opportunity": {
            "type": "object",
            "properties": {
                "asset": {},
                "confidence": {
                ...
                "risk_level": {
                    "$ref": "#/definitions/github_com_systentandobr_invest-tracker_internal_domain_analysis_entity.RiskLevel"
                },
                "status": {
                    "$ref": "#/definitions/github_com_systentandobr_invest-tracker_internal_domain_analysis_entity.OpportunityStatus"
                },
                "tags": {
                    "type": "array",
                    "items": {
        ...
        "github_com_systentandobr_invest-tracker_internal_domain_analysis_entity.OpportunityStatus": {
            "type": "string",
            "enum": [
                "active",
                "expired",
        ...
        "github_com_systentandobr_invest-tracker_internal_domain_analysis_entity.RiskLevel": {
            "type": "string",
            "enum": [
                "low",
                "medium",
        ...
        "github_com_systentandobr_invest-tracker_internal_domain_notification_entity.Notification": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
        ...
        "github_com_systentandobr_invest-tracker_internal_domain_simulation_entity.Simulation": {
            "type": "object",
            "properties": {
                "asset": {},
                "completedAt": {
                ...
                "results": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_systentandobr_invest-tracker_internal_domain_simulation_entity.SimulationResult"
                    }
                },
                "scenarios": {
                ...
                "status": {
                    "$ref": "#/definitions/github_com_systentandobr_invest-tracker_internal_domain_simulation_entity.SimulationStatus"
                },
                "stopLoss": {
                    "type": "number"
                },
                "strategy": {
                    "$ref": "#/definitions/github_com_systentandobr_invest-tracker_internal_domain_analysis_entity.InvestmentStrategy"
                },
                "targetPrice": {
                    "type": "number"
                },
        ...
        "github_com_systentandobr_invest-tracker_internal_domain_simulation_entity.SimulationResult": {
            "type": "object",
            "properties": {
                "annualizedROI": {
                    "type": "number"
        ...
        "github_com_systentandobr_invest-tracker_internal_domain_simulation_entity.SimulationStatus": {
            "type": "string",
            "enum": [
                "pending",
                "running",
        ...
        "github_com_systentandobr_invest-tracker_internal_domain_user_entity.FinancialGoal": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
        ...
        "github_com_systentandobr_invest-tracker_internal_domain_user_entity.Portfolio": {
            "type": "object",
            "properties": {
                "assets": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_systentandobr_invest-tracker_internal_domain_user_entity.PortfolioAsset"
                    }
                },
                "id": {
                    "type": "string"
        ...
        "github_com_systentandobr_invest-tracker_internal_domain_user_entity.PortfolioAsset": {
            "type": "object",
            "properties": {
                "assetId": {
                    "type": "string"
