...
export declare class AchievementService {
    ...
    constructor(achievementModel: Model<AchievementDocument>, userAchievementModel: Model<UserAchievementDocument>, gamificationProfileModel: Model<GamificationProfileDocument>);
    ...
    checkAndUnlockAchievements(userId: string, userStats: {
        totalPoints: number;
        streak: number;
