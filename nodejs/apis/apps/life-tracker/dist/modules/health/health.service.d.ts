...
export declare class HealthService {
  ...
  private recipeModel;
  constructor(
    healthPlanModel: Model<HealthPlan>,
    latestLabsModel: Model<LatestLabs>,
    dietParametersModel: Model<DietParameters>,
  ...
  markMeal(mealData: { day: string; meal: string }): Promise<ApiResponse<any>>;
