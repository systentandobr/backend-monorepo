...
import { FranchiseTask, FranchiseTaskSchema } from './schemas/franchise-task.schema';
import { TaskTemplatesModule } from '../task-templates/task-templates.module';

@Module({
    imports: [
        MongooseModule.forFeature([{ name: FranchiseTask.name, schema: FranchiseTaskSchema }]),
        TaskTemplatesModule,
    ],
